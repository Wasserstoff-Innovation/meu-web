export const countryOptions = [
  { countryCode: "AF", value: "+93", label: "Afghanistan (+93)" },
  { countryCode: "AL", value: "+355", label: "Albania (+355)" },
  { countryCode: "DZ", value: "+213", label: "Algeria (+213)" },
  { countryCode: "AS", value: "+1684", label: "American Samoa (+1684)" },
  ...
  { countryCode: "TD", value: "+235", label: "Chad (+235)" },
  ...
  { countryCode: "US", value: "+1", label: "United States (+1)" },
  ...
  { countryCode: "WF", value: "+681", label: "Wallis & Futuna (+681)" },
